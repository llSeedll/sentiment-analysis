...
'''
input >> weight > hl1 (activation function) > weights > hl 2 > (activation function)
> weights > output

compare output to intended input > cost function (cross entropy)
...
def train_neural_network(x):
	...
	#cycles of feedforward + back prop
	hm_epochs = 500
